...
╠➥ 3.0
╠➥ CREATOR : TAHTA BOT
╠➥ (FAZONE-SANZ-GALUH-DIMASDM)
╠➥ *Mau jadi User Premium* ? Pm #owner
╠➥ Pinjemin nomer buat verifikasi ( ga usah bayar )
║
╠══✪〘 LIST MENU 〙✪══
║
╠➥ *#ownermenu*
...
║
╚═〘 JST BOT 〙
~> *MAU MASUKIN BOT KE GROUP* ? WAJIB PINJEMIN NOMER, PM #OWNER
`
}
exports.help = help()
function ownercmd() {
...
╔══✪〘 MEDIA 〙✪══
║
╠➥ *#magernulis1 --[Nama Kamu]--[Kelas Kamu]--[Teks]*
...
Contoh : *#tiktokstalk @kimi.hime*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *#igstalk @kimi.hime*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *#smulestalk @kimi.hime*
...
╠➥ *NAME : JST BOT*
╠➥ *VERSION : 2.0*
╠➥ *GITHUB : github.com/vpnkacang-jstfreenet*
...
exports.info = info()
function snk() {
    return `Syarat dan Ketentuan Bot *JST*
...
║
╠➥ *DONASI BISA MELALUI :*
╠➥ *DANA/PULSA/OVO : 081325714976*
╠➥ *PAYPAL : ubosju@gmail.com*
╠➥ *TELEGRAM : t.me/JSTFREENET*
